        ...
        <table class="min-w-full bg-white border border-gray-200 rounded-lg shadow-sm">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                <tr class="hover:bg-gray-50 transition-colors duration-150">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $doctor->phone }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">{{ $doctor->specialization }}</td>
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                        ...
                        <form action="{{ route('doctors.destroy', $doctor) }}" method="POST" class="inline-block">
                            @csrf
                            @method('DELETE')
                            <button type="submit" 
